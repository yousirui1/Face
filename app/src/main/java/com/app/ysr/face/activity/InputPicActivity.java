...
public class InputPicActivity extends Activity implements FaceView.OnFaceDetectorListener{
    ...
    public void onFace(Mat mat, Rect rect) {
        if (isGettingFace) {
            ...
            if (null == mBitmapFace1 || null != mBitmapFace2) {
                ...
                mBitmapFace2 = null;
                // 保存人脸信息并显示
                int n =mFaceFaceUtil.getPicId(this);
                n++;
                mFaceFaceUtil.saveImage(mat, rect, ""+n);
                mBitmapFace1 = mFaceFaceUtil.getImage(""+n);
                mFaceFaceUtil.setPicId(n,this);
                ...
                n++;
                mFaceFaceUtil.saveImage(mat, rect, ""+n);
                mBitmapFace2 = mFaceFaceUtil.getImage(""+n);
                // 计算相似度
